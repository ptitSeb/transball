...
TGLobject_tank::TGLobject_tank(float x,float y,int type) : TGLobject_enemy(x,y)
{
	m_state=0;
	m_hitpoints=10;
	m_type=type;
...
void TGLobject_tank::draw(GLTManager *GLTM)
{
	int tmp=(m_cycle/2)%5;

	if (m_type==0) {
		if (tmp==0) m_last_tile=GLTM->get("objects/grey-tank-body1");
		if (tmp==1) m_last_tile=GLTM->get("objects/grey-tank-body2");
		if (tmp==2) m_last_tile=GLTM->get("objects/grey-tank-body3");
		if (tmp==3) m_last_tile=GLTM->get("objects/grey-tank-body4");
		if (tmp==4) m_last_tile=GLTM->get("objects/grey-tank-body5");
	} // if 
	if (m_type==1) {
		if (tmp==0) m_last_tile=GLTM->get("objects/red-tank-body1");
		if (tmp==1) m_last_tile=GLTM->get("objects/red-tank-body2");
		if (tmp==2) m_last_tile=GLTM->get("objects/red-tank-body3");
		if (tmp==3) m_last_tile=GLTM->get("objects/red-tank-body4");
		if (tmp==4) m_last_tile=GLTM->get("objects/red-tank-body5");
	} // if 
	if (m_type==2) {
		if (tmp==0) m_last_tile=GLTM->get("objects/green-tank-body1");
		if (tmp==1) m_last_tile=GLTM->get("objects/green-tank-body2");
		if (tmp==2) m_last_tile=GLTM->get("objects/green-tank-body3");
		if (tmp==3) m_last_tile=GLTM->get("objects/green-tank-body4");
		if (tmp==4) m_last_tile=GLTM->get("objects/green-tank-body5");
	} // if 
