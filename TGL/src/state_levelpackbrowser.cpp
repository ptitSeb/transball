...
int TGLapp::levelpackbrowser_cycle(KEYBOARDSTATE *k)
{
	...
	if (m_state_cycle==0) {
		...
		m_lpb_select_button=new TGLbutton("Select",m_font32,240,404,160,64,0);
	...
	return TGL_STATE_LEVELPACKBROWSER;
} /* TGLapp::levelpackbrowser_cycle */ 


void TGLapp::levelpackbrowser_draw(void)
{
//	char buffer[255];
