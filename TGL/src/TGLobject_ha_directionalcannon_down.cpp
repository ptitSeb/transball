...
TGLobject_ha_directionalcannon_down::TGLobject_ha_directionalcannon_down(float x,float y,int ao) : TGLobject_enemy(x+15,y+12,ao)
{
	m_state=0;
	m_hitpoints=12;
	m_angle=270;
} /* TGLobject_ha_directionalcannon_down::TGLobject_ha_directionalcannon_down */ 
...
bool TGLobject_ha_directionalcannon_down::cycle(VirtualController *k,class TGLmap *map,GLTManager *GLTM,SFXManager *SFXM,int sfx_volume)
{
	TGLobject_ship *ship;
	m_cycle++;
	bool in_range=false;
	...
	return true;
} /* TGLobject_ha_directionalcannon_down::cycle */ 


void TGLobject_ha_directionalcannon_down::draw(GLTManager *GLTM)
{
...
} /* TGLobject_ha_directionalcannon_down::draw */ 


bool TGLobject_ha_directionalcannon_down::is_a(Symbol *c)
{
	if (c->cmp("TGLobject_ha_directionalcannon_down")) return true;
	return TGLobject_enemy::is_a(c);
} /* TGLobject_ha_directionalcannon_down::is_a */ 


bool TGLobject_ha_directionalcannon_down::is_a(char *c)
{
	bool retval;
...
const char *TGLobject_ha_directionalcannon_down::get_class(void)
{
	return "TGLobject_ha_directionalcannon_down";
} /* TGLobject_ha_directionalcannon_down::get_class */ 
