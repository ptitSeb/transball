...
TGLobject_directionalcannon_right::TGLobject_directionalcannon_right(float x,float y,int ao) : TGLobject_enemy(x+12,y+15,ao)
{
	m_state=0;
	m_hitpoints=12;
	m_angle=180;
} /* TGLobject_directionalcannon_right::TGLobject_directionalcannon_right */ 
...
bool TGLobject_directionalcannon_right::cycle(VirtualController *k,class TGLmap *map,GLTManager *GLTM,SFXManager *SFXM,int sfx_volume)
{
	TGLobject *ship;
	m_cycle++;
	bool in_range=false;
	...
	return true;
} /* TGLobject_directionalcannon_right::cycle */ 


void TGLobject_directionalcannon_right::draw(GLTManager *GLTM)
{
...
} /* TGLobject_directionalcannon_right::draw */ 


bool TGLobject_directionalcannon_right::is_a(Symbol *c)
{
	if (c->cmp("TGLobject_directionalcannon_right")) return true;
	return TGLobject_enemy::is_a(c);
} /* TGLobject_directionalcannon_right::is_a */ 


bool TGLobject_directionalcannon_right::is_a(char *c)
{
	bool retval;
...
const char *TGLobject_directionalcannon_right::get_class(void)
{
	return "TGLobject_directionalcannon_right";
} /* TGLobject_directionalcannon_right::get_class */ 
