...
TGLobject_ha_directionalcannon_up::TGLobject_ha_directionalcannon_up(float x,float y,int ao) : TGLobject_enemy(x+16,y+19,ao)
{
	m_state=0;
	m_hitpoints=12;
	m_angle=90;
} /* TGLobject_ha_directionalcannon_up::TGLobject_ha_directionalcannon_up */ 
...
bool TGLobject_ha_directionalcannon_up::cycle(VirtualController *k,class TGLmap *map,GLTManager *GLTM,SFXManager *SFXM,int sfx_volume)
{
	TGLobject_ship *ship;
	m_cycle++;
	bool in_range=false;
	...
	return true;
} /* TGLobject_ha_directionalcannon_up::cycle */ 


void TGLobject_ha_directionalcannon_up::draw(GLTManager *GLTM)
{
...
} /* TGLobject_ha_directionalcannon_up::draw */ 


bool TGLobject_ha_directionalcannon_up::is_a(Symbol *c)
{
	if (c->cmp("TGLobject_ha_directionalcannon_up")) return true;
	return TGLobject_enemy::is_a(c);
} /* TGLobject_ha_directionalcannon_up::is_a */ 


bool TGLobject_ha_directionalcannon_up::is_a(char *c)
{
	bool retval;
...
const char *TGLobject_ha_directionalcannon_up::get_class(void)
{
	return "TGLobject_ha_directionalcannon_up";
} /* TGLobject_ha_directionalcannon_up::get_class */ 
