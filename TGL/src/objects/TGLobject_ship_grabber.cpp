...
void TGLobject_ship_grabber::draw(GLTManager *GLTM)
{
	if (m_last_mask==0) m_last_mask=GLTM->get("objects/ship-harpoon-5");
	if (m_last_tile==0) m_last_tile=GLTM->get("objects/ship-harpoon-5");
