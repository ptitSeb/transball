...
TGLobject_ha_directionalcannon_left::TGLobject_ha_directionalcannon_left(float x,float y,int ao) : TGLobject_enemy(x+19,y+15,ao)
{
	m_state=0;
	m_hitpoints=12;
	m_angle=0;
} /* TGLobject_ha_directionalcannon_left::TGLobject_ha_directionalcannon_left */ 
...
void TGLobject_ha_directionalcannon_left::draw(GLTManager *GLTM)
{
...
} /* TGLobject_ha_directionalcannon_left::draw */ 


bool TGLobject_ha_directionalcannon_left::is_a(Symbol *c)
{
	if (c->cmp("TGLobject_ha_directionalcannon_left")) return true;
	return TGLobject_enemy::is_a(c);
} /* TGLobject_ha_directionalcannon_left::is_a */ 


bool TGLobject_ha_directionalcannon_left::is_a(char *c)
{
	bool retval;
...
const char *TGLobject_ha_directionalcannon_left::get_class(void)
{
	return "TGLobject_ha_directionalcannon_left";
} /* TGLobject_ha_directionalcannon_left::get_class */ 
