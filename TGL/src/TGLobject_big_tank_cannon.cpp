...
TGLobject_big_tank_cannon::TGLobject_big_tank_cannon(float x,float y,TGLobject_enemy *tank) : TGLobject_enemy(x+15,y+12)
{
	m_state=0;
	m_hitpoints=12;
	m_angle=270;
...
void TGLobject_big_tank_cannon::draw(GLTManager *GLTM)
{
